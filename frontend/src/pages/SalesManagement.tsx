  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-4 sm:p-6 border-4 border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
        <div>
          <h1 className="text-2xl sm:text-3xl font-black text-black uppercase">Penjualan & Keuangan</h1>
          <p className="text-gray-700 font-bold mt-1 text-sm sm:text-base">Catat transaksi dan pantau performa cuan mingguan.</p>
        </div>
